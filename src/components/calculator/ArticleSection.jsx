      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <div className="prose prose-sm md:prose-base max-w-none text-muted-foreground space-y-6 leading-relaxed">
            ...
            <p>
              Cepot maizi, kūkas vai citus konditorejas izstrādājumus, mīklas sastāvdaļu attiecībai ir izšķiroša nozīme. Pārāk daudz miltu padara kūku sausu, bet pārāk maz – par šķidru. Sāls, cepamā pulvera vai sodas pārpalikums var pilnībā sabojāt garšu. Tāpēc pieredzējuši konditori vienmēr izmanto svarus vai precīzas mērkārotes, nevis mēra "uz aci". Tomēr ikdienā svari nav vienmēr pieejami, un tieši tāpēc virtuves kalkulators ir tik noderīgs - tas palīdz ātri pārrēķināt gramus no glāzēm un karotēm.
            </p>
            ...
            <p>
              Glāze ir viena no senākajām virtuves mērvienībām, un tā tiek lietota gandrīz visās Eiropas valstīs. Latvijā tradicionāli ar "glāzi" saprot 250 ml tilpumu - tieši tik daudz ietilpst standarta tējas glāzē. Taču mūsdienās mājsaimniecībās bieži atrodamas 200 ml vai pat 300 ml glāzes, kas var radīt pārpratumus, ja recepte ir rakstīta, domājot par 250 ml standartu.
            </p>
            <p>
              Šķidrumus glāzē mērīt ir vienkārši - ielej un pārbaudi ar acīm. Beramus produktus glāzē jāber ar karoti, nevis pa tiešo no trauka, lai produkts pārāk neblīvētos. Pareizi mērīti milti (iebērti ar karoti glāzē un nolīdzināti) sver aptuveni 160 gramus 250 ml glāzē. Turpretī, ja miltus glāzē ber tieši no maisa un sablīvē, svars var palielināties par 20–40 gramiem.
            </p>
            ...
            <p>
              Tradicionālajos latviešu ēdienos - rupjmaizē, pelēkajos zirņos, skābeņu zupā un kāpostu tīteņos, mērvienību precizitāte ir ļoti svarīga. Piemēram, pareizs sāls daudzums kāpostu rūgšanā nosaka fermentācijas procesu. Rupjmaizes mīklā miltu un šķidruma attiecība ietekmē maizes blīvumu un garoziņas konsistenci. Mūsu kalkulators ir veidots tā, lai latviešu valodā runājošiem mājsaimniekiem būtu ērti pārrēķināt šos daudzumus modernās receptēs.
            </p>
            ...
            <ul className="space-y-2 list-disc list-inside text-muted-foreground">
              <li>Izmantojiet vienu un to pašu glāzi vai karoti visas gatavošanas laikā, lai proporcijas saglabātos vienmērīgas.</li>
              <li>Miltus vienmēr beriet glāzē ar karoti, pirms tam nolīdzinot lieko. Neberiet tieši no maisa.</li>
              <li>Šķidrumus (pienu, ūdeni, eļļu) vislabāk mērīt ar mērkrūzi, kas ļauj precīzi nolasīt ml.</li>
              <li>Sviestam, margarīnam un bieziem produktiem (piemēram, tomātu pastai) lūdziet palīgu — pārrēķiniet ar mūsu kalkulatoru vai izmantojiet svarus.</li>
